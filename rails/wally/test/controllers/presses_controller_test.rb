...
class PressesControllerTest < ActionController::TestCase
  ...
  test "should create press" do
    assert_difference('Press.count') do
      post :create, press: { main_email: @press.main_email, name: @press.name, phone: @press.phone, secondary_mail: @press.secondary_mail }
    end
  ...
  test "should update press" do
    patch :update, id: @press, press: { main_email: @press.main_email, name: @press.name, phone: @press.phone, secondary_mail: @press.secondary_mail }
    assert_redirected_to press_path(assigns(:press))
  end
